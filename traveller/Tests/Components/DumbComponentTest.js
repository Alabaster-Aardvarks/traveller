...
import DumbComponent from '../../App/Components/DumbComponent'

const wrapper = shallow(<DumbComponent />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('DumbComponent Component')) // That the Component Text is included
})
